...
interface ILiquidBookEngine {
    ...
    function placeOrder(uint256 incoming_order_volume, int128 incoming_order_tick, address incoming_order_user, bool incoming_order_is_buy, bool incoming_order_is_market) external returns (uint256, int128, uint256);
}
