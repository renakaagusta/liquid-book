...
```
git clone https://github.com/OffchainLabs/liquid-book-storage && cd liquid-book-storage
```
...
Reading WASM file at liquid-book-storage/target/wasm32-unknown-unknown/release/liquid-book-storage.wasm
