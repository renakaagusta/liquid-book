...
cast send $MATCHER_ADDRESS "initialize(address,address,address,address)" $TICK_ADDRESS $BITMAP_ADDRESS $ORDER_ADDRESS $POOL_ORDERBOOK_ADDRESS --rpc-url $RPC_URL --private-key $STYLUS_LOCAL_DEV_PK
