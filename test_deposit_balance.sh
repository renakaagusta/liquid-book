...
# cast send --rpc-url $RPC_URL --private-key $STYLUS_LOCAL_DEV_PK $USER_2_ADDRESS --value 100000000000000000000

# # Send ETH to USER_3 for gas
# cast send --rpc-url $RPC_URL --private-key $STYLUS_LOCAL_DEV_PK $USER_3_ADDRESS --value 100000000000000000000
