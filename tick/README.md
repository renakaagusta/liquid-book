...
```
git clone https://github.com/OffchainLabs/tick-manager && cd tick-manager
```
...
Reading WASM file at tick-manager/target/wasm32-unknown-unknown/release/tick-manager.wasm
