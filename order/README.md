...
```
git clone https://github.com/OffchainLabs/order-manager && cd order-manager
```
...
Reading WASM file at order-manager/target/wasm32-unknown-unknown/release/order-manager.wasm
